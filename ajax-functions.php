...
add_action( 'wp_ajax_srm_muc_umeta_search', 'srm_muc_umeta_search' );
add_action( 'wp_ajax_nopriv_srm_muc_umeta_search', 'srm_muc_umeta_search' );
if (!function_exists('srm_muc_umeta_search')) {
	function srm_muc_umeta_search() {
